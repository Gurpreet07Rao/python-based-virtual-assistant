import sys
sys.path.insert(0, r'C:\Users\Gurpreet Yadav\AppData\Roaming\Python\Python313\site-packages')
import requests
...
def take_user_input():
    """Takes user input, either by voice or text"""
